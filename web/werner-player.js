...
var _cssPath = __webpack_require__(13);
...
function playSlide(element, slideConfigs) {
	(0, _preact.render)((0, _preact.h)(_player2.default, {
		ref: function ref(instance) {
			return playerInstances[(0, _cssPath2.default)(element)] = instance;
		},
...
function onSceneLoad(hype) {
	var sceneContainerId = hype.documentId(),
	    ...
	    playerInstance = playerInstances[(0, _cssPath2.default)(playerRoot)],
...
var trim = __webpack_require__(14),
    classSelector = function classSelector(className) {
  ...
  return array.join('');
    ...
    nthChild = function nthChild(elm) {
  var childNumber = 0,
  ...
  for (; index < childNodes.length; ++index) {
    ...
    path = function path(elm, rootNode, list) {
