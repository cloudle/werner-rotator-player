...
exports.__esModule = true;
exports.playSlide = playSlide;

var _preact = __webpack_require__(0);

var _uniqueSelector = __webpack_require__(6);
...
function playSlide(element, slideConfigs) {
	(0, _preact.render)((0, _preact.h)(_player2.default, {
		ref: function ref(instance) {
			return playerInstances[(0, _uniqueSelector2.default)(element)] = instance;
		},
		configs: slideConfigs, container: element }), element);
}

var hypeEventListeners = global.HYPE_eventListeners || [];
global.HYPE_eventListeners = [].concat(hypeEventListeners, [{
	type: 'HypeSceneLoad', callback: function callback(scene) {
		setTimeout(function () {
...
function onSceneLoad(hype) {
	var sceneContainerId = hype.documentId(),
	    ...
	    playerInstance = playerInstances[(0, _uniqueSelector2.default)(playerRoot)],
	    currentSceneName = hype.currentSceneName(),
	    layouts = hype.layoutsForSceneNamed(currentSceneName),
	    currentLayout = (0, _utils.getCurrentLayout)(layouts, playerRoot.clientWidth),
	    currentScene = (0, _utils.arrayFind)(layouts, function (layout) {
...
var _getID = __webpack_require__(7);

var _getClasses = __webpack_require__(8);

var _getCombinations = __webpack_require__(9);

var _getAttributes = __webpack_require__(10);

var _getNthChild = __webpack_require__(11);

var _getTag = __webpack_require__(12);

var _isUnique = __webpack_require__(13);

var _getParents = __webpack_require__(14);
...
var _slideItem = __webpack_require__(16);
...
var _indicatorContainer = __webpack_require__(20);
...
var Player = function (_Component) {
	...
	function Player(props) {
		...
		_this.renderSlides = function () {
			...
			if (slides.length === 1) {
				var route = slides[0] || {},
				    name = route.name,
				    url = route.url;
				return (0, _preact.h)(_slideItem2.default, { index: 0, name: name, url: url });
		...
		_this.onResize = function (e) {
			var _this$props$container = _this.props.container,
			    clientWidth = _this$props$container.clientWidth,
			    clientHeight = _this$props$container.clientHeight;


			_this.setState({
				width: clientWidth,
				height: clientWidth / _this.state.widthRatio
			});
		};

		_this.updateRatio = function (_ref) {
			var sceneWidth = _ref.sceneWidth,
			    sceneHeight = _ref.sceneHeight;
			var _this$props$container2 = _this.props.container,
			    clientWidth = _this$props$container2.clientWidth,
			    clientHeight = _this$props$container2.clientHeight,
...
var _validUrl = __webpack_require__(17);
...
var SlideItem = function (_Component) {
	...
	function SlideItem(props) {
		...
		_this.injectScript = function () {
			...
			script.src = _this.props.url;
			while (script.firstChild) {
				script.removeChild(script.firstChild);
			}
			_this.scriptContainer.appendChild(script);
		};
	...
	SlideItem.prototype.componentDidMount = function componentDidMount() {
		this.injectScript();
	};
...
var _maxamedIndicator = __webpack_require__(3);

var _maxamedIndicator2 = _interopRequireDefault(_maxamedIndicator);

var _ubaxIndicator = __webpack_require__(21);

var _ubaxIndicator2 = _interopRequireDefault(_ubaxIndicator);

var _magoolIndicator = __webpack_require__(22);
...
function getCurrentLayout(layouts, containerWidth) {
